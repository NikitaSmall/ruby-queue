...
module Handlers
  module GoogleAnalytics
    module Referring
      class ReferringParser
        include Celluloid
        include Handlers::ActorHelper

        def run(task)
          log 'Referring task started'
        ...
        def run_task_process_result(task)
          Celluloid::Actor[actor_name GoogleAnalytics::Referring::SourceProcessResult] = GoogleAnalytics::Referring::SourceProcessResult.new
          Celluloid::Actor[actor_name GoogleAnalytics::Referring::SourceProcessResult].run task
        end
