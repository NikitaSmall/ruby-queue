...
module Handlers
  module GoogleAnalytics
    module TrafficMetricsReport
      class TrafficMetricsReportParser
        include Celluloid
        include Handlers::ActorHelper

        def run(task)
          log 'TrafficMetricsReport task started'
        ...
        def run_task_process_result(task)
          Celluloid::Actor[actor_name GoogleAnalytics::TrafficMetricsReport::TrafficMetricsReportProcessResult] = GoogleAnalytics::TrafficMetricsReport::TrafficMetricsReportProcessResult.new
          Celluloid::Actor[actor_name GoogleAnalytics::TrafficMetricsReport::TrafficMetricsReportProcessResult].run task
        end
