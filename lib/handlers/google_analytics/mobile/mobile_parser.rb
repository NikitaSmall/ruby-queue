    ...
    module Mobile
      class MobileParser
        ...
        def run_task_process_result(task)
          Celluloid::Actor[actor_name GoogleAnalytics::Mobile::MobileProcessResult] = GoogleAnalytics::Mobile::MobileProcessResult.new
          Celluloid::Actor[actor_name GoogleAnalytics::Mobile::MobileProcessResult].run task
        end
